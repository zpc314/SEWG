...
public class Interface {
    ...
    private void setPrivateKey(@Nullable String privateKey) {
        if (privateKey != null && privateKey.isEmpty())
            privateKey = null;
        keypair = privateKey == null ? null : new Keypair(privateKey, context);
    }
    ...
    public static class Observable extends BaseObservable implements Parcelable {
        ...
        public void generateKeypair() {
            final Keypair keypair = new Keypair(Application.get());
        ...
        public void setPrivateKey(final String privateKey) {
            ...
            try {
                publicKey = new Keypair(privateKey, Application.get()).getPublicKey();
