...
func (device *Device) ConsumeMessageResponse(msg *MessageResponse) *Peer {
	if msg.Type != MessageResponseType {
	    device.log.Error.Printf("msg.Type != MessageResponseType\n")
		return nil
	}
	...
	if handshake == nil {
	    device.log.Error.Printf("handshake == nil\n")
		return nil
	}
	...
	ok := func() bool {
		...
		if err != nil {
		    device.log.Error.Printf("err != nil\n")
			return false
		}
		mixHash(&hash, &hash, msg.Empty[:])
		device.log.Error.Printf("ok := func() bool success\n")
		return true
	}()
